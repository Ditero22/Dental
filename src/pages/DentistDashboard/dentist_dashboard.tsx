    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat) => (
          ...
          >
            <div
              className={`${stat.bgColor} p-3 rounded-full flex items-center justify-center`}
            >
              {stat.icon}
            </div>
            <div>
      ...
      {/* Charts Grid: 8 columns (5:3) */}
      <div className="grid grid-cols-8 gap-8">
        {/* Left Column: Line + Bar charts (span 5) */}
        <div className="col-span-8 lg:col-span-5 grid grid-rows-2 gap-6">
        ...
        {/* Right Column: Pie Charts (span 3) */}
        <div className="col-span-8 lg:col-span-3 grid grid-rows-2 gap-6">
            ...
            <div className="mt-4 flex flex-col items-center gap-2">
              {patientDemographics.map((item, index) => (
                <div key={index} className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-sm text-gray-600">{item.value} {item.name}</span>
                </div>
              ))}
            </div>
          </div>
