...
export const defaultUsers: User[] = [
  ...
  { id: 4, name: "Dentist", contact: "1234", email: "dentist@example.com", password: "dentist", role: "Dentist" },
];

export const defaultPatients: Patient[] = [
  { id: 1, name: "Patient Name", age: 30, contact: "1234", email: "1234", password: "1234" },
